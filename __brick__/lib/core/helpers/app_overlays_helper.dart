...
class AppOverlaysHelper extends BaseOverlaysHelper {
  ...
  Future<T?> showDialog<T>(Widget dialog, {bool barrierDismissible = true, RouteSettings? settings}) {
    return _getHelper().showAppDialog((context) => dialog, barrierDismissible: barrierDismissible, settings: settings);
  }
