...
class AppFieldPicker<T> extends StatefulWidget {
  ...
  @override
  State<AppFieldPicker<T>> createState() => _AppFieldPickerState<T>();
}

class _AppFieldPickerState<T> extends State<AppFieldPicker<T>> {
