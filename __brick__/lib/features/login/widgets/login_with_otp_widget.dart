...
class LoginWithOtpWidget extends HookConsumerWidget {
  ...
  final int timerValue;
   LoginWithOtpWidget({super.key, required this.onBack, required this.onConfirmCode, required this.onChangePhone, required this.timerValue, required this.onResendCode});
  @override
  Widget build(BuildContext context ,WidgetRef ref) {
    ...
    useEffect((){
      ref.read(receivedCodeProvider.notifier).addListener((a) {
        try {
          if(ref.read(signupStepProvider)==5) {
            pinC.setText(a);
          }
        }catch(e){
          log("error on auto ${e}");
